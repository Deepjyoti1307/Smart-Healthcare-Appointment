...
const Threads: React.FC<ThreadsProps> = ({
    ...
    useEffect(() => {
        ...
        try {
            ...
            if (!testGL) {
                console.warn('WebGL not supported, skipping Threads animation');
                return;
            }
            ...
            console.error('Error initializing Threads animation:', error);
            // Fallback: create a simple CSS animation div
